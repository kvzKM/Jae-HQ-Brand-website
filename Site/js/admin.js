...
const CONTENT_CONFIG = {
    posts: {
        label: "Blog posts",
        eyebrow: "Publishing",
        description: "Create and manage blog content records. Phase 4 will connect published posts to SEO-friendly public URLs.",
        singular: "post",
        titleField: "title",
        meta(record) {
...
function renderComments() {
    ...
    if (!comments.length) {
        list.innerHTML = `<div class="admin-empty">No Firestore comments yet. Phase 4 will replace the old localStorage comment system.</div>`;
        return;
    }
